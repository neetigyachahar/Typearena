...
function createFloor(){ 
  floor = new THREE.Mesh(new THREE.PlaneBufferGeometry(100,500), new THREE.MeshBasicMaterial({color: 0x1c1c1c}));
...
function Lion(){
  ...
  var tv = this.body.geometry.vertices;

  for (var i=0;i<this.bodyVertices.length; i++){
    tv[this.bodyVertices[i]];
    tv.z =70;
    //tv.x = 0;
